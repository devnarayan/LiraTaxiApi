(function () {
    ...
    function customerController($scope, $http) {
        ...
        $http.get($scope.bashPath + '/api/Customer/').success(function (data) {
        ...
        $scope.add = function () {
            $scope.loading = true;
            $http.post( $scope.bashPath+'/api/Customer/', this.newcustomer).success(function (data) {
        ...
        $scope.save = function () {
            ...
            alert(frien);
            $http.put($scope.bashPath + '/api/Customer/' + frien.Id, frien).success(function (data) {
        ...
        $scope.deletecustomer = function () {
            ...
            $http.delete($scope.bashPath + '/api/Customer/' + Id).success(function (data) {
